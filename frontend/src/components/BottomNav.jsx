...
export default function BottomNav() {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-stone-200 shadow-[0_-4px_20px_rgba(0,0,0,0.05)]">
      <div className="w-full flex items-center justify-around pb-safe h-16">
        <NavLink 
          to="/" 
          end
